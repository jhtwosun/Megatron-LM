...
def add_multimodal_args(parser):
    ...
    group.add_argument(
        "--mdp-decoder-cp-routing",
        choices=("full_leaf", "cp_local"),
        default="full_leaf",
        help=(
            "Decoder-CP vision routing mode. full_leaf remains the default "
            "correctness oracle; cp_local enables compact transport."
        ),
    )
    group.add_argument(
