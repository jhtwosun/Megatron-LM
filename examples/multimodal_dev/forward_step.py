...
def _prepare_prepacked_batch(batch: Dict[str, Any]) -> Dict[str, Any]:
    ...
    batch["packed_seq_params"] = PackedSeqParams(
        qkv_format="thd",
        cu_seqlens_q=cu_seqlens.to(dtype=torch.int32),
        cu_seqlens_kv=cu_seqlens.to(dtype=torch.int32),
        cu_seqlens_q_padded=cu_seqlens_padded.to(dtype=torch.int32),
        cu_seqlens_kv_padded=cu_seqlens_padded.to(dtype=torch.int32),
